...
public class AdminSongs extends javax.swing.JFrame {

    //Here we make the obj of SongsFileHandling =>
    SongsFileHandling h = new SongsFileHandling();

    //AdminSongs constructor
    public AdminSongs(boolean b) {
    }

    //AdminSongs constructor (OVERLOADING)
    public AdminSongs() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("MUSICLOUD");
        setPreferredSize(new java.awt.Dimension(1354, 730));

        jScrollPane1.setPreferredSize(new java.awt.Dimension(1360, 730));
        ...
        jScrollPane2.setBackground(new java.awt.Color(27, 27, 27));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminSongs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
