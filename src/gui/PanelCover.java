...
public class PanelCover extends javax.swing.JPanel {
    ...
    //Main Panel of Login and Register Design
    private void init() {
        labelImg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/musicloud.png")));
        add(labelImg);
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, new Color(105, 105, 105), 0, getHeight(), new Color(21, 21, 21));
        g2.setPaint(gra);
    ...
    public void login(boolean login) {
        if (this.isLogin != login) {
            ...
            if (login) {
                ...
                description1.setText("Click on SingUp to start journey with us");
