...
public class AdminViewUser extends javax.swing.JFrame {
    ...
    //AdminViewUser constructor
    public AdminViewUser() {
        initComponents();
        jLabel12.setText("ADMIN");
        addUserDataInTable(arrlist);
    }
    //Here we create the obj of UserFileHandling,ArrayList<User> which is getting the User from the txt file
    UserFileHandling h = new UserFileHandling();
    ArrayList<User> arrlist = h.getUsers();

    //Here we create another obj of UserFileHandling which we use further
    UserFileHandling users = new UserFileHandling();

    //This method show's User Data in JTable by getting the ArrayList of User
    public void addUserDataInTable(ArrayList<User> list) {
        ...
        model.setRowCount(0);
        //Now making the obj of Object class rowData[] and making it an array so it can easily stores data 
        // in the cells or rows

        Object rowData[] = new Object[4];
        for (int i = 0; i < list.size(); i++) {
            rowData[0] = list.get(i).getFullName();
            rowData[1] = list.get(i).getPassword();
    ...
    private void initComponents() {
        ...
        jButton8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/plus 1.png"))); // NOI18N
        jButton8.setText("ADD SONGS");
        ...
        jButton10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/edit 1.png"))); // NOI18N
        jButton10.setText("EDIT SONGS");
        ...
        jButton11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/delete 1.png"))); // NOI18N
        jButton11.setText("DELETE SONGS");
        ...
        jScrollPane3.setBackground(new java.awt.Color(47, 47, 47));
        ...
        jLabel14.setText("To Delete User Select Row and Press Delete");
    ...
    //This Button is deleting the User
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        //DefaultTableModel is used for storing data in cells    
        
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        if (jTable1.getSelectedRowCount() == 1) {
            //getting the information of the selected row 
            String user = (String) jTable1.getValueAt(jTable1.getSelectedRow(), 2);
            //removing the selected row 
            model.removeRow(jTable1.getSelectedRow());
            //Callling function to delete the user from the UserFileHandling or txt file
            users.deleteUser(user);
            new PlayListFileHandling().deletePlayListFile(user);
            JOptionPane.showMessageDialog(this, "The user has been deleted successfully.", "delete Successfully", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, "No user has been selected for deletion. Please select a user first.", "User Not Selected", JOptionPane.ERROR_MESSAGE);
        }
