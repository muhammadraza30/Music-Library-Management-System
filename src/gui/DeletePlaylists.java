 ...
 */
public class DeletePlaylists extends javax.swing.JFrame {
    ...
    if (row > 0) {
        String playlistName = (String) jTable1.getValueAt(row, 0); // Assuming playlist name is in the second column
        System.out.println("Deleting playlist: " + playlistName);

        PlayListFileHandling playListFileHandler = new PlayListFileHandling();
        playListFileHandler.deletePlaylist(playlistName);
        
        // Now you can update your UI or perform any additional actions
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeletePlaylists.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeletePlaylists().setVisible(true);
            }
        });
    }
